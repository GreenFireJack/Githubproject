...
public class CountDistanceUtil {
     ...
     * @param template
     */
    public static int count(String background,String template) {
...
//        URL slideBlockResource = classLoader.getResource(template);
        ...
        URL slideBgResource = classLoader.getResource(background);
